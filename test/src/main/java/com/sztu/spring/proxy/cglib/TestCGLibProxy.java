...
public class TestCGLibProxy {
	public static void main(String[] args) {
		System.setProperty(DebuggingClassWriter.DEBUG_LOCATION_PROPERTY, "D:\\Java_projects\\spring-framework-5.2.x\\test\\src\\main\\java\\com\\sztu\\spring\\proxy\\cglib\\clazz");
