...
*
*
* <bean id="logUtil" class="com.sztu.spring.aopTest.LogUtil"></bean>

	<bean id="myCalculator" class="com.sztu.spring.aopTest.MyCalculator"></bean>

	<aop:config>
		<aop:aspect ref="logUtil"> 																								 <!--指定切入逻辑类 aspect-->
			<aop:pointcut id="myPoint" expression="execution(Integer com.sztu.spring.aopTest.MyCalculator.*(Integer,Integer))"/> <!--所有的连接点们  join point-->
...
* 需要怎么样才能完成上述步骤呢？
*
* a: 知道哪些类需要进行切入    ->  expression="execution(Integer com.sztu.spring.aopTest.MyCalculator.*(Integer,Integer))
